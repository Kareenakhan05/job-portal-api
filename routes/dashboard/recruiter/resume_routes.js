...
const { get_resumes, issue_offer_letter, view_resume, toggle_pin_resume } = require('../../../controllers/dashboard/recruiter/resume_controller');
const { auth_middleware } = require('../../../middlewares/auth_middleware');
const { validate_fetch_resumes, validate_issue_offer, validate_view_resume, validate_toggle_pin, validate_request } = require('../../../validators/dashboard/recruiter/resume_validator');
